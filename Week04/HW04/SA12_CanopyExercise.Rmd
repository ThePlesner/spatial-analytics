...
author: "Adela Sobotkova - Assignments completed by Mikkel Plesner Ottosen"
date: "28/02/2021 updated `r format(Sys.time(), '%B %d, %Y')`" 
output:
...
map1 <- tm_shape(manhattan) + 
  tm_rgb() + 
  tm_layout(main.title = "Manhattan")
  

map2 <- tm_shape(neighborhoods) + 
  tm_polygons("tree_density", palette = "Greens", 
        title = "Trees per sq. KM") +
  tm_layout(main.title = "Tree_density")


map3 <- tm_shape(neighborhoods) + 
  tm_polygons("avg_canopy", palette = "Greens", 
        title = "Trees per sq. KM") + 
  tm_layout(main.title = "avg_canopy")
